...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>appintro</b> with <b>com.github.AppIntro:AppIntro</b> coordinates and
     * with version reference <b>appintro</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getAppintro() {
        return create("appintro");
    }
    ...
    public static class HiltCompilerLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>ksp</b> with <b>com.google.dagger:hilt-compiler</b> coordinates and
         * with version reference <b>hilt</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKsp() {
            return create("hilt.compiler.ksp");
        }
    ...
    public static class RoomLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>ktx</b> with <b>androidx.room:room-runtime</b> coordinates and
        ...
        /**
         * Dependency provider for <b>lifecycle</b> with <b>androidx.lifecycle:lifecycle-livedata-ktx</b> coordinates and
         * with version reference <b>room</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getLifecycle() {
            return create("room.lifecycle");
        }

        /**
         * Dependency provider for <b>runtime</b> with <b>androidx.room:room-ktx</b> coordinates and
         * with version reference <b>room</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class RoomCompilerLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public Provider<MinimalExternalModuleDependency> getKsp() {
            return create("room.compiler.ksp");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>appintro</b> with value <b>6.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAppintro() { return getVersion("appintro"); }
